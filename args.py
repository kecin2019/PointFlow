...
def add_args(parser):
    ...
    parser.add_argument(
        "--zdim", type=int, default=128, help="Dimension of the shape code"
    )
    parser.add_argument(
        "--optimizer",
        type=str,
    ...
    parser.add_argument(
        "--lr", type=float, default=1e-3, help="Learning rate for the Adam optimizer."
    )
    ...
    parser.add_argument(
        "--prior_weight", type=float, default=1.0, help="Weight for the prior loss."
    )
    parser.add_argument(
        "--entropy_weight", type=float, default=1.0, help="Weight for the entropy loss."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default="shapenet15k",
        help="Dataset types.",
        choices=["shapenet15k", "modelnet40_15k", "modelnet10_15k"],
    )
    parser.add_argument(
        "--cates",
        type=str,
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="/workspace/dataset/ShapeNet/ShapeNetCore.v2.PC15k",
        help="Path to the training data",
    )
    parser.add_argument(
        "--mn40_data_dir",
        type=str,
        default="data/ModelNet40.PC15k",
        help="Path to ModelNet40",
    )
    parser.add_argument(
        "--mn10_data_dir",
        type=str,
        default="data/ModelNet10.PC15k",
    ...
    parser.add_argument(
        "--num_workers", type=int, default=4, help="Number of data loading threads"
    )

    # logging and saving frequency
    parser.add_argument(
        "--log_name", type=str, default=None, help="Name for the log dir"
    )
    ...
    parser.add_argument(
        "--no_eval_sampling", action="store_true", help="Whether to evaluate sampling."
    )
    parser.add_argument(
        "--max_validate_shapes",
        type=int,
